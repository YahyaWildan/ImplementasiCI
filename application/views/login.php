	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo base_url()."index.php/depan/proses_login_anggota"; ?>" method="POST">
					...
					<div class="text-center p-t-16">
						<a class="txt2" href="<?php echo base_url()."index.php/depan/regis"; ?>">
							Create your Account
